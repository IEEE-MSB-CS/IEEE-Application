...
public class FragmentSignUpBindingImpl extends FragmentSignUpBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.orText, 2);
        sViewsWithIds.put(R.id.centerOfSignIn, 3);
        sViewsWithIds.put(R.id.noAccountTextView, 4);
    }
    // views
    @NonNull
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x1L) != 0) {
            ...
            com.ieee.events.utils.BindingAdapter.changeTextColor(this.mboundView1, "By sigining you agree to our Terms of Use and Privacy Policy");
        }
    }
